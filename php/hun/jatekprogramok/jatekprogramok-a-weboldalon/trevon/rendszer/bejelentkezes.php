...
else
{
	...
	{	
		...
		else
		{
			...
			header("Location: character-ellenorzes.php");
		}
	}
}
...
<form id="form" name="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"><!--$_SERVER['PHP_SELF']-->
	<table>
	<tr>
	<td colspan="2"><p>Amennyiben m&eacute;g nem regisztr&aacute;lt a<br /> felhaszn&aacute;l&oacute;nk, k&eacute;rem kattintson <a href="registration.php">IDE!</a><br />
	<font face color="red">*: K&ouml;telez&ocirc; mez&ocirc;!</font></p></td>
	</tr>
	<tr>
	<td>Felhaszn&aacute;l&oacute;:*</td><td><input type="text" name="user" id="user" size="10" maxlength="8" /></td>
	</tr><tr>
	<td>Jelsz&oacute;:*</td><td><input type="password" name="password" id="password" size="10" maxlength="30" /></td>
	</tr><tr>
	<td colspan="2"><input type="hidden" name="elsoe" value="$_POST['elsoe']" /><input type="submit" value="Bejelentkez&eacute;s" />
	<input class="right" type="button" name="megse" onClick="location.href='../../jatekprogramok-a-weboldalon.php'" Value="M&eacute;gse" /></td>
	</tr>
	</table>
</form>
</div>
