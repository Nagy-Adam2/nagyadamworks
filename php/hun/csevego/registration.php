...
<title>Regisztrációs adatlap kitöltése</title>
<link rel="stylesheet" type="text/css" href="style.css" />
</head>
<body>
<div id="stilusos" class="formom">
	<h1>Regisztráció</h1>
	<p><font face color="red">*: Kötelező mező!</font></p><br>
	<form id="form" name="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	<table class ="kicsi">
	<tr>
		<td width=170><strong>Felhasználói név:*</strong></td>
		<td><input type="text" name="user_name" value="" size=30 maxlength=8></td>
	</tr>
	<tr>
		<td width=170><strong>Teljes név:*</strong></td> 
		<td><input type="text" name="full_name" value="" size=30 maxlength=30></td>
	</tr>
	<tr>
		<td width=170><strong>E-mail cím:*</strong></td>
		<td><input type="text" name="email" value="" size=30 maxlength=30></td>
	</tr>
	<tr>
		<td width=170><strong>Jelszó:*</strong></td>
		<td><input type="password" name="password1" size=30 maxlength=15></td>
	</tr>
	<tr>
		<td width=170><strong>Jelszó mégegyszer:*</strong></td>
		<td><input type="password" name="password2" size=30 maxlength=15></td>
	</tr>
	<tr>
	<td colspan="2">Elfogadom a regisztrációs feltételeket!	 (A regisztrációhoz szükséges)<input name="reg_felt" type="checkbox" value="elfogad"'.($_POST['reg_felt'] == "elfogad" ? ' CHECKED' : '').'>	
	<input type="hidden" name="elsoe" value="'.$_POST['elsoe'].'"></td>	
	</tr><tr>
	<td colspan="2"><input name="kuldes" type="submit" value="Küldés"><input class="right" type="button" name="megse" onClick="location.href='bejelentkezes.php'" Value="Mégse" /></td>	
	</tr>
	</table>
	</form>
</div>
