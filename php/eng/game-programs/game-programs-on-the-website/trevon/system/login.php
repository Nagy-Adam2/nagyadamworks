...
else
{
	...
	{	
		...
		else
		{
			...
			header("Location: character-checking.php");
		}
	}
}
...
<form id="form" name="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"><!--$_SERVER['PHP_SELF']-->
	...
	<input class="right" type="button" name="cancel" onClick="location.href='../../game-programs-on-the-website.php'" Value="Cancel" /></td>
	</tr>
	</table>
</form>
</div>
