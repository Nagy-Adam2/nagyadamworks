...
Game.World.TileSet = function(columns, tile_size) {
  ...
  this.frames = [new f(115,  96, 13, 16, 0, -2), 
                 new f( 50,  96, 13, 16, 0, -2), 
                 new f(102,  96, 13, 16, 0, -2), new f(89, 96, 13, 16, 0, -2), new f(76, 96, 13, 16, 0, -2), new f(63, 96, 13, 16, 0, -2),
                 new f(  0, 112, 13, 16, 0, -2),
                 new f( 65, 112, 13, 16, 0, -2), 
                 new f( 13, 112, 13, 16, 0, -2), new f(26, 112, 13, 16, 0, -2), new f(39, 112, 13, 16, 0, -2), new f(52, 112, 13, 16, 0, -2)
                ];
